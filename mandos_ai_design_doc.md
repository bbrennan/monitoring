...
### In scope for v1
- a working repo-level custom Copilot agent file at `.github/agents/mandos-analyst.agent.md`
- strong agent instructions that define behavior, tone, error handling, and grounding rules
- built-in Copilot tool usage where available, including codebase search, file reading, and terminal/command execution
